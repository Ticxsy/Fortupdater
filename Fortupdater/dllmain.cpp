...
VOID Main()
{
	...
	uintptr_t UObjectArray = (uintptr_t)MemoryHelper::Pattern::PatternScan(("48 8B 05 00 00 00 00 4C 8D 34 CD"));
	UObjectArray = reinterpret_cast<uintptr_t>(RELATIVE_ADDR(UObjectArray, 7));
	uintptr_t GetNameByIndex = (uintptr_t)MemoryHelper::Pattern::PatternScan(("48 89 5C 24 00 55 56 57 48 8B EC 48 83 EC 30 8B"));
	uintptr_t GetObjectName = (uintptr_t)MemoryHelper::Pattern::PatternScan(("40 53 48 83 EC 20 48 8B D9 48 85 D2 75 45 33 C0 48 89 01 48 89 41 08 8D 50 05 E8 00 00 00 00 8B 53 08 8D 42 05 89 43 08 3B 43 0C 7E 08 48 8B CB E8 00 00 00 00 48 8B 0B 48 8D 15 00 00 00 00 41 B8 00 00 00 00 E8 00 00 00 00 48 8B C3 48 83 C4 20 5B C3 48 8B 42 18"));
	uintptr_t FnFree = (uintptr_t)MemoryHelper::Pattern::PatternScan(("48 85 C9 74 2E 53 48 83 EC 20 48 8B D9 48 8B 0D 00 00 00 00 48 85 C9 75 0C"));
